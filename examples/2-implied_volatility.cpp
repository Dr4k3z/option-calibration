...
int main(){
       ...
       std::cout << "ImpliedVol BS = " << BlackScholes::impliedVolatility(call,1,0.03,marketPrice) << std::endl;
       std::cout << "ImpliedVol CRR = " << CRR::impliedVolatility(call,1,0.03,marketPrice) << std::endl;
}